...
// The key fix is ensuring we get the app that Genkit is using, NOT the default app.
// We can use getApp() without arguments here as Genkit ensures the default app is initialized.
