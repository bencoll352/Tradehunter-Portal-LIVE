...
const INITIAL_SEED_TRADERS_DATA_RAW: Omit<Trader, 'id' | 'lastActivity'>[] = [
  ...
  { name: 'Bob The Builder', branchId: 'PURLEY', tradesMade: 120, status: 'Call-Back', description: 'Can he fix it? Yes, he can! General construction and home repair services. Reliable and efficient.', rating: 4.8, phone: '01234 567802', 
  ...
  { name: 'Charlie Brown', branchId: 'PURLEY', tradesMade: 90, status: 'Inactive', 
  ...
  { name: 'Diana Prince', branchId: 'BRANCH_B', tradesMade: 200, status: 'Active', address: '789 Amazon Way, Themyscira, THM 001', phone: '01234 567803', 
  ...
  { name: 'Edward Scissorhands', branchId: 'BRANCH_B', tradesMade: 180, status: 'New Lead', website: 'https://edwardcuts.example.com', description: 'Unique topiary and avant-garde hairdressing services. Gentle and artistic.', rating: 4.9, ownerProfileLink: 'https://example.com/edward', 
  ...
  { name: 'Fiona Gallagher', branchId: 'BRANCH_C', tradesMade: 165, status: 'Active', description: 'South Side resilience. Runs a local cafe and diner. Known for hearty meals and a welcoming atmosphere.', 
  ...
  { name: 'George Jetson', branchId: 'DOVER', tradesMade: 250, status: 'New Lead', description: 'Digital Indexer at Spacely Space Sprockets. Future-proof solutions.', rating: 4.0, phone: '01234 567805', 
  ...
  { name: 'Laura Croft', branchId: 'LEATHERHEAD', tradesMade: 210, status: 'Active', description: 'Supplier of rare archaeological equipment and expedition gear. Expert in ancient artifacts.', website: 'https://croftarch.example.com', phone: '01372 100201', address: 'Croft Manor, Leatherhead, SUR 123', 
  ...
  { name: 'Henry "Indiana" Jones Jr.', branchId: 'LEATHERHEAD', tradesMade: 95, status: 'Call-Back', description: 'Procurement of ancient relics and historical items. Often on field assignments.', rating: 4.7, phone: '01372 100202', 
  ...
  { name: 'Nathan Drake', branchId: 'LEATHERHEAD', tradesMade: 70, status: 'Inactive', 
  ...
  { name: 'Elara Vance', branchId: 'LEATHERHEAD', tradesMade: 15, status: 'New Lead', description: 'Provides cartography services and exploration planning. New to the area.', rating: null, phone: '01372 100204', 
  ...
  { name: 'Pete The Plasterer', branchId: 'PURLEY', tradesMade: 80, status: 'Active', description: 'Smooth finishes every time. Residential and commercial plastering.', rating: 4.6, phone: '01234 567812',
  ...
  { name: 'Roger The Roofer', branchId: 'BRANCH_B', tradesMade: 95, status: 'Call-Back', description: 'Top quality roofing solutions, from repairs to new installations.', rating: 4.7, phone: '01234 567813',
  ...
  { name: 'Dave The Developer', branchId: 'BRANCH_C', tradesMade: 25, status: 'Active', description: 'Large scale property development and new builds.', rating: 4.3, phone: '01234 567814',
  ...
  { name: 'Paula The Painter', branchId: 'DOVER', tradesMade: 110, status: 'New Lead', description: 'Interior and exterior painting and decorating services. Meticulous work.', rating: 4.9, phone: '01234 567815',
  ...
  { name: 'Carl The Carpenter', branchId: 'LEATHERHEAD', tradesMade: 130, status: 'Active', description: 'Custom carpentry, joinery, and bespoke furniture.', rating: 4.8, phone: '01372 100205',
