...
const INITIAL_SEED_TRADERS_DATA_RAW: Omit<Trader, 'id' | 'lastActivity'>[] = [
  ...
  { name: 'Laura Croft', branchId: 'LEATHERHEAD', totalSales: 180000, tradesMade: 210, status: 'Active', description: 'Supplier of rare archaeological equipment and expedition gear. Expert in ancient artifacts.', website: 'https://croftarch.example.com', phone: '01372 100201', address: 'Croft Manor, Leatherhead, SUR 123', mainCategory: 'Specialty Goods', ownerName: "Lara Croft", ownerProfileLink: "https://example.com/laracroft", categories: "Archaeology, Expedition, Antiques", workdayTiming: "Mon-Fri 9am-6pm", closedOn: "Weekends", reviewKeywords: "rare, artifacts, adventure, quality", rating: 4.9, notes: "Key supplier for university expeditions.", callBackDate: null, annualTurnover: 400000, totalAssets: 1200000 },
  { name: 'Henry "Indiana" Jones Jr.', branchId: 'LEATHERHEAD', totalSales: 120000, tradesMade: 95, status: 'Call-Back', description: 'Procurement of ancient relics and historical items. Often on field assignments.', rating: 4.7, phone: '01372 100202', mainCategory: 'Consulting', categories: 'History, Relics, Academia', address: "Barnett College Dept. of Archaeology", ownerName: "Dr. Henry Jones Jr.", ownerProfileLink: "https://example.com/indy", workdayTiming: "Varies (often unavailable)", closedOn: null, reviewKeywords: "knowledgeable, adventurous, rare finds", website: null, notes: "Follow up regarding the Crystal Skull shipment. Prefers to be called Indy.", callBackDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(), annualTurnover: 200000, totalAssets: 600000 },
  { name: 'Nathan Drake', branchId: 'LEATHERHEAD', totalSales: 65000, tradesMade: 70, status: 'Inactive', mainCategory: 'Services', address: 'Unknown - Last seen heading to Shambhala', workdayTiming: "Irregular", description: "Treasure hunter and adventurer. Supplier of climbing gear and maps. Currently on a long expedition.", phone: "01372100203", ownerName: "Nathan Drake", reviewKeywords:"treasure, adventure, maps", rating: 4.2, website: null, ownerProfileLink: null, categories: "Adventure Gear, Cartography", closedOn: null, notes: "Account inactive, expected back in 6 months.", callBackDate: null, annualTurnover: 90000, totalAssets: 50000 },
  { name: 'Elara Vance', branchId: 'LEATHERHEAD', totalSales: 22000, tradesMade: 15, status: 'New Lead', description: 'Provides cartography services and exploration planning. New to the area.', rating: null, phone: '01372 100204', mainCategory: 'Services', categories: 'Mapping, Exploration, Logistics', address: "The Map Room, Leatherhead", ownerName: "Elara Vance", workdayTiming: "Mon-Fri 10am-4pm", website: 'https://elarasmaps.example.com', ownerProfileLink: null, closedOn: "Weekends", notes: "New lead, interested in surveying equipment.", callBackDate: null, annualTurnover: 30000, totalAssets: 10000 },
];
