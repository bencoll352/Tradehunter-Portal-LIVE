...
// Represents a single task associated with a trader
export const TaskSchema = z.object({
  id: z.string(),
  traderId: z.string(),
  title: z.string(),
  dueDate: z.string(), // ISO 8601 date string
  completed: z.boolean(),
});
...
export const ReportSchema = z.object({
  id: z.string(),
  title: z.string(),
  generatedDate: z.string(), // ISO 8601 date string
  data: z.any(), // This can be customized based on the report's content
});
